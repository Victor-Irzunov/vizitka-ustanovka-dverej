		...
		<footer className="footer footer-center p-10 bg-base-200 text-base-content rounded" id='contacts'>
			...
			<nav>
				{/* <h6 className='mb-1 w-[60vw] font-semibold'>
					Для размещения заказа на товар, вы можете воспользоваться кнопкой «Заказать» на нашем сайте или воспользоваться одним из следующих способов:
				</h6> */}
				{/* <div className="grid grid-flow-col gap-4">
					<a href="https://www.instagram.com/obuvcomplekt2023" target="_blank">
				...
				<div className=''>
					<h6 className='text-xl uppercase mb-2'>
						Контакты
					</h6>
					<div className='flex'>
					<a href='tel:80296097085' className=' font-bold sd:text-3xl xz:text-2xl mr-2'>
						8 029 609-70-85
						</a>
