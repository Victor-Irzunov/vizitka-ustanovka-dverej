const dataPrice = [
	...
	{ work: 'Установка раздвижной одиночной двери', price: '80 (100)' },
	{ work: 'Установка раздвижной двойной двери', price: '130 (160)' },
	{ work: 'Установка портала', price: '50' },
	{ work: 'Установка порога', price: '8' },
	{ work: 'Сбитие откоса', price: 'от 50' },
	{ work: 'Сбитие порога', price: 'от 10' },
	{ work: 'Установка магнитного механизма (AGB), замка', price: '12' },
	{ work: 'Врезка скрытой петли 1 шт', price: '10' },
	{ work: 'Подрезка полотна', price: 'от 10' },
	{ work: 'Доплата за установку (если в заказе 1 дверь)', price: 'от 30' },
];
