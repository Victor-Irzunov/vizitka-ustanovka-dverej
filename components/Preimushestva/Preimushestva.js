				...
				<div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8 xl:gap-10'>
					...
					<div className="card bg-base-200 transform-gpu transition-all duration-300 hover:-translate-y-2 hover:shadow-lg">
						<div className="card-body items-center text-center gap-4">
							...
							<p className="text-sm base-content">
							Мы гарантируем качество наших услуг благодаря использованию в работе инструмента мировых брендов (Вosch, Makita, Dewalt), а так же специализированных шаблонов, позволяющих выполнять качественную заводскую врезку петель и замков. Все работы организовываются с эффективным пылеудалением.
							</p>
						</div>
					</div>
				</div>
